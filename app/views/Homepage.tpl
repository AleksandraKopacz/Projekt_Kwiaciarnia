...
{block name=content}
    <div id="mainimage">
        <img src="{$conf->app_url}/assets/images/mainimage.jpg" class="img-fluid" alt="Responsive image">
    ...
    <div class="container text-center">
        ...
        <div class="row align-items-center">
            <div class="col">
                ...
                <img src="{$conf->app_url}/assets/images/icon.png" class="img-fluid" alt="Lavender icon">
