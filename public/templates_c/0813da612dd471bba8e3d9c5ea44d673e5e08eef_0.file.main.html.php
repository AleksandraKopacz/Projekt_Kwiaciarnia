<?php
/* Smarty version 4.3.0, created on 2023-06-26 12:36:34
  from 'C:\xampp\htdocs\Kwiaciarnia\app\views\templates\main.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.0',
  'unifunc' => 'content_64996a32983058_54798137',
...
function content_64996a32983058_54798137 (Smarty_Internal_Template $_smarty_tpl) {
...
/edit">Narzędzia dla administratora</a>
                ...
                <?php } elseif (\core\RoleUtils::inRole('0')) {?>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo $_smarty_tpl->tpl_vars['conf']->value->app_root;?>
/orderView">Zamów kwiaty</a>
                </li>
                <?php } else { ?>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo $_smarty_tpl->tpl_vars['conf']->value->app_root;?>
...
<main id="main">
    <?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_209106975964996a3297e1c6_72948299', 'content');
?>
...
/bouquet" id="flinks">Bukiety</a></p>
                    <?php if (\core\RoleUtils::inRole('1')) {?>
                    <p><a href="<?php echo $_smarty_tpl->tpl_vars['conf']->value->app_root;?>
/edit" id="flinks">Narzędzia dla administratora</a></p>
                    <?php } elseif (\core\RoleUtils::inRole('0')) {?>
                    <p><a href="<?php echo $_smarty_tpl->tpl_vars['conf']->value->app_root;?>
/orderView" id="flinks">Zamów kwiaty</a></p>
                    <?php } else { ?>
                    <p><a href="<?php echo $_smarty_tpl->tpl_vars['conf']->value->app_root;?>
...
<?php }
/* {block 'content'} */
class Block_209106975964996a3297e1c6_72948299 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'content' => 
  array (
    0 => 'Block_209106975964996a3297e1c6_72948299',
  ),
);
