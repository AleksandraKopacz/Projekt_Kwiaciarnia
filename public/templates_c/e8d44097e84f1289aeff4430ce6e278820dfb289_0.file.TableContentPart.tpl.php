...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array(
    ...
    function content_649961888d7159_56498146(Smarty_Internal_Template $_smarty_tpl)
    {
        ...
        if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['r']->value) {
            ...
            ?>
            <tr>
                <td><?php echo $_smarty_tpl->tpl_vars['r']->value["id_uslugi"]; ?>
                </td>
                <td><?php echo $_smarty_tpl->tpl_vars['r']->value["img"]; ?>
                </td>
                <td><?php echo $_smarty_tpl->tpl_vars['r']->value["usluga"]; ?>
                </td>
                <td><?php echo $_smarty_tpl->tpl_vars['r']->value["opis"]; ?>
                </td>
                <td><?php echo $_smarty_tpl->tpl_vars['r']->value["cena_uslugi"]; ?>
                </td>
                <td><?php echo $_smarty_tpl->tpl_vars['r']->value["typ"]; ?>
                </td>
            </tr>
            <?php
        }
        ...
        if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['r']->value) {
            ...
            ?>
            <tr>
                <td><?php echo $_smarty_tpl->tpl_vars['r']->value["id_uzytkownik"]; ?>
                </td>
                <td><?php echo $_smarty_tpl->tpl_vars['r']->value["email"]; ?>
                </td>
                <td><?php echo $_smarty_tpl->tpl_vars['r']->value["haslo"]; ?>
                </td>
                <td><?php echo $_smarty_tpl->tpl_vars['r']->value["rola"]; ?>
                </td>
            </tr>
            <?php
        }
        ...
        if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['r']->value) {
            ...
            ?>
            <tr>
                <td><?php echo $_smarty_tpl->tpl_vars['r']->value["id_zamowienie"]; ?>
                </td>
                <td><?php echo $_smarty_tpl->tpl_vars['r']->value["szczegoly"]; ?>
                </td>
                <td><?php echo $_smarty_tpl->tpl_vars['r']->value["id_uzytkownik"]; ?>
                </td>
            </tr>
